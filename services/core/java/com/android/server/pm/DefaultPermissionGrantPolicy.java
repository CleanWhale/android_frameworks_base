    ...
    private void grantDefaultSystemHandlerPermissions(int userId) {
        ...
        synchronized (mService.mPackages) {
            ...
            if (googleaccountPackage != null
					&& doesPackageSupportRuntimePermissions(googleaccountPackage)) {
            ...
            if (googleappPackage != null
					&& doesPackageSupportRuntimePermissions(googleappPackage)) {
            ...
            if (gmscorePackage != null
					&& doesPackageSupportRuntimePermissions(gmscorePackage)) {
            ...
            PackageParser.Package gmscorepersistentPackage = getSystemPackageLPr(
					"com.google.android.gms.persistent");
            if (gmscorepersistentPackage != null
					&& doesPackageSupportRuntimePermissions(gmscorepersistentPackage)) {
                grantRuntimePermissionsLPw(gmscorepersistentPackage, SENSORS_PERMISSIONS, userId);
                grantRuntimePermissionsLPw(gmscorepersistentPackage, CALENDAR_PERMISSIONS, userId);
                grantRuntimePermissionsLPw(gmscorepersistentPackage, CAMERA_PERMISSIONS, userId);
                grantRuntimePermissionsLPw(gmscorepersistentPackage, CONTACTS_PERMISSIONS, userId);
                grantRuntimePermissionsLPw(gmscorepersistentPackage, LOCATION_PERMISSIONS, userId);
                grantRuntimePermissionsLPw(gmscorepersistentPackage, MICROPHONE_PERMISSIONS, userId);
                grantRuntimePermissionsLPw(gmscorepersistentPackage, PHONE_PERMISSIONS, userId);
                grantRuntimePermissionsLPw(gmscorepersistentPackage, SMS_PERMISSIONS, userId);
                grantRuntimePermissionsLPw(gmscorepersistentPackage, STORAGE_PERMISSIONS, userId);
            }
            ...
            if (gcsPackage != null
					&& doesPackageSupportRuntimePermissions(gcsPackage)) {
            ...
            if (googlecontactssyncPackage != null
					&& doesPackageSupportRuntimePermissions(googlecontactssyncPackage)) {
            ...
            if (googlebackuptransportPackage != null
					&& doesPackageSupportRuntimePermissions(googlebackuptransportPackage)) {
            ...
            if (gsfcorePackage != null
					&& doesPackageSupportRuntimePermissions(gsfcorePackage)) {
            ...
            if (setupwizardPackage != null
					&& doesPackageSupportRuntimePermissions(setupwizardPackage)) {
            ...
            if (vendingPackage != null
					&& doesPackageSupportRuntimePermissions(vendingPackage)) {
